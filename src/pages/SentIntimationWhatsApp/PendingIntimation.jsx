...
import IntimationForm from './IntimationForm';

const PendingIntimation = ({ indents, onProcess, SortDropdown, onSort }) => {
        ...
        <div className="flex-1 bg-white/90 backdrop-blur-sm border border-sky-100 rounded-2xl shadow-lg overflow-hidden flex flex-col">
            ...
            {indents.length === 0 && (
                <div className="text-center py-12 text-slate-400">
                    ...
                    <p>No pending WhatsApp intimations.</p>
                </div>
            )}
...
export default PendingIntimation;
