...
const Login = () => {
    ...
    const demoCredentials = [
        ...
        { role: 'Manager', username: 'manager', password: 'manager123', color: 'sky' },
        { role: 'Staff', username: 'staff', password: 'staff123', color: 'purple' }
    ];
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 via-white to-sky-100 p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-slate-800">Crest Purchase</h1>
                    <p className="text-slate-500 text-sm mt-1">Purchase Management System</p>
                </div>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {demoCredentials.map((cred) => (
                                <button
                                    ...
                                    className={`p-2 rounded-xl text-center transition-all hover:scale-105 ${cred.color === 'emerald' ? 'bg-emerald-50 hover:bg-emerald-100 border border-emerald-200' :
